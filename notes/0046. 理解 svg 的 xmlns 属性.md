---
id: 70a5d9f3-979d-49c9-9a30-b63dc48abcf1
---
...
- 使用浏览器打开后看到的效果：
  - ![](../assets/0046-2024-12-05-14-00-04.png)
  - 可以正常渲染
...
- 使用浏览器打开后看到的效果：
  - ![](../assets/0046-2024-12-05-14-00-34.png)
  - 无法正常渲染
...
- 使用浏览器打开后看到的效果：
  - ![](../assets/0046-2024-12-05-14-10-09.png)
  - 会发现两者都能正常渲染。
...
- ![](../assets/0046-2024-12-09-14-53-23.png)
...
- `1.svg` 是搬运过来的原始内容，用浏览器打开后看到的内容如下：
  - ![](../assets/0046-2024-12-09-15-01-53.png)
- `2.svg` 是在 1.svg 的基础上加上了 xmlns 声明，用浏览器打开后看到的内容如下：
  - ![](../assets/0046-2024-12-09-15-01-49.png)
