---
id: aa0eea79-31c9-4670-8e22-0594a3e60a67
---
...
![](../assets/0034-2024-12-09-15-54-05.png)
...
- ![](../assets/0034-2024-12-09-15-55-18.png)
...
- ![](../assets/0034-2024-12-09-15-56-06.png)
- ![](../assets/0034-2024-12-09-15-56-36.png)
...
- 在没有写 `viewBox` 的情况下（或者 `viewBox="0 0 500 500"`），看到的坐标系区域是 `(0, 0) 到 (500, 500)`，我们所绘制的图形将按照 `1:1` 的效果来显示。也就是绘制的是多大，看到的就是多大。
  - ![](../assets/0034-2024-12-09-16-02-21.png)
